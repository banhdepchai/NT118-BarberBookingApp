...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.txt_cart_price.setText(new StringBuilder(String.valueOf(cartItemList.get(i).getProductPrice())).append(" VND"));
        ...
        myViewHolder.setListener(new IImageButtonListener() {
            ...
            public void onImageButtonClick(View view, int pos, boolean isDecrease) {
                if (isDecrease) {
                    if (cartItemList.get(pos).getProductQuantity() > 0) {
                        cartItemList.get(pos)
                                .setProductQuantity(cartItemList.get(pos)
                ...
                myViewHolder.txt_cart_quantity.setText(new StringBuilder(String.valueOf(cartItemList.get(pos).getProductQuantity())));
